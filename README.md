...
The API was developed to learn how to configure Authentication and Authorization in a Spring application using Spring Security.
...
```bash
git clone https://github.com/antonioferreirasales/auth-api.git
```
